...
let propositions = {
  ...
  3: {
    ...
    content:
      "Bonjour à tous, il m'arrive souvent d'avoir ce genre de remarques, comment gérez-vous ?",
    isAnon: false,
    nbLikes: 18,
    owner: 1,
    tags: [],
  ...
  4: {
    ...
    content:
      "J'ai été victime de cette remarque sexiste de mon beau père avant hier lors d'un repas de famille, quelle honte !",
    isAnon: false,
    nbLikes: 47,
    owner: 2,
    tags: [],
